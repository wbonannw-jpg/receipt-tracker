...
※【重要】レシートに消費税・内税・外税・税（8%・10%など）の行がある場合は、それらも必ず items に含めてください。例: { "name": "消費税(10%)", "price": 80, "category": "その他", "subCategory": null }
※品目の price の合計が totalAmount と一致するように抽出してください。税別レシートでは消費税を別 item として追加することで合計を合わせてください。
※各商品に対して「category」を推測し、「${categoryNames}」の中から最も適切なものを1つ選んで出力してください。消費税など税金の行は category を「その他」としてください。
